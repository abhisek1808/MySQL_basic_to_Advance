/* How many databases in your workbench */
show databases

/*create database*/
create database abhi_sql

/* which database you want to use */
use abhi_sql

/*If the database doesn't exists then only it will be created else not */
create database if not exists abhi_sql

/* create table in the database and 
inbuilt key words  not used in mysql but
we can use in built key words by using backtick (``) */
...
/* show all data present in the table */
...
/* how many data rows in table*/
select count(*) from bank_details

/* how to show selected coulmn from the table */
select job,balance,loan from bank_details

select `default`,`day`,`month` from bank_details

/*how to show first 5  data rows */
select * from bank_details limit 5 

/* where clause use  when condition are apply */ 
...
/* how to show how many types of job role (use distinct) */
select distinct job from bank_details

/* how to show data rows ascending order 
...
select *,min(balance) from bank_details /* this query is wrong */
...
/* try to find out who is having a maximum balance */
select *,max(balance) from bank_details /* this query is wrong */
...
select * from bank_details where balance = (select max(balance) as MaxBalance from bank_details)
